	...
	function displaydata(){
		...
		if (!namevalid || !activityvalid || !languagevalid){
			writetoelement("allaboutyou", "Please enter your name and activity", "purple");
			return false;
		}
	...
	function reportactivity(){
		...
		writetoelement("activityreport", "you like to " + activityselected, "purple");
	}
